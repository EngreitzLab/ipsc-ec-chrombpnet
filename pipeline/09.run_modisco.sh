...
# =============================================================================
# 09.run_modisco.sh
# Purpose: Run TF-MoDISco on fold-averaged contribution scores (step 07).
#          One SLURM array job per day; produces ONE modisco result per day
...
#
# Input:  results/contrib_scores/{day}/{day}_average_shaps.counts.h5  (step 07)
# Output: ${averaged_dir}/{day}/modisco/
#             modisco_counts_results.h5
#             counts_report/
#
# Usage:
#   sbatch 09.run_modisco.sh            # all days (array 0-4)
#   sbatch --array=0 09.run_modisco.sh  # d0 only
#
...
mkdir -p "${averaged_dir}/${day}/modisco/counts_report" "${log_dir}"
...
echo "[$(date)] Day ${day}: running MoDISco on averaged counts scores..."

# modisco motifs \
#     -i "${averaged_dir}/${day}/${day}_average_shaps.counts.h5" \
#     -n 500000 \
#     -o "${averaged_dir}/${day}/modisco/modisco_counts_results.h5" \
#     -w 500 \
#     -v
