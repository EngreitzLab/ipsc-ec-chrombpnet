#!/usr/bin/env python3
# =============================================================================
# 3.1.1.avg_contribs_to_bigwig.py
# Purpose: Convert the fold-averaged contribution score H5 produced by
#          3.1.average_contrib_scores.py into a bigwig file.
#
...
#
# Input:
#   {averaged_dir}/{day}/average_shaps.counts.h5
#   interpretation.interpreted_regions.bed  (from any single fold;
#       rows must match the averaged H5 — all folds use the same peaks)
#
# Output:
#   {averaged_dir}/{day}/average_shaps.counts.bw
#
# Usage:
#   python 3.1.1.avg_contribs_to_bigwig.py \
#       --h5          /path/to/average_shaps.counts.h5 \
#       --regions     /path/to/interpretation.interpreted_regions.bed \
#       --chrom-sizes /path/to/hg38.chrom.sizes \
#       --output-bw   /path/to/average_shaps.counts.bw
# =============================================================================
...
def parse_args():
    ...
    p.add_argument("--h5", required=True,
                   help="Path to average_shaps.counts.h5")
    ...
    p.add_argument("--output-bw", required=True,
                   help="Output bigwig path")
    p.add_argument("--debug-chr", type=str, default=None,
...
def main():
    ...
    bigwig_helper.write_bigwig(
        scores, regions, gs, args.output_bw,
